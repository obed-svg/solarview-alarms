...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://solarview:solarview@localhost:5432/solarview_alarms",
    ),
}
...
# Cache Redis: requerido por los locks anti-solape de evaluate_project
# (LocMemCache no sirve: cada worker tendría su propio lock)
